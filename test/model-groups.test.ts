...
test('local endpoint groups under "Local" regardless of maker', () => {
  ...
  assert.equal(modelGroup(m('glm-5.2-redapex', { baseUrl: 'http://127.0.0.1:8002/v1' })), 'Local');
